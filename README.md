...
- [**price-watcher**](https://github.com/Kennurken/price-watcher) — Chrome extension: pick a price on any page, track history, alert on drops
- [**pdf-toolkit**](https://github.com/Kennurken/pdf-toolkit) — CLI to merge, split, watermark PDFs and fill AcroForms from CSV
- [**messy-data-parser**](https://github.com/Kennurken/messy-data-parser) — cleans broken CSV/Excel exports, writes a tidy workbook + PDF summary
- [**webchat-sales-desk**](https://github.com/Kennurken/webchat-sales-desk) — website chat widget with FAQ, lead intake, Slack/WhatsApp alerts
- [**form-to-sheet-notify**](https://github.com/Kennurken/form-to-sheet-notify) — Apps Script: validate Google Form replies, notify Telegram, email fallback
...
![Dart](https://img.shields.io/badge/Flutter-02569B?style=flat-square&logo=flutter&logoColor=white)
